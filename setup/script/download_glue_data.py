"""Scripts from https://gist.github.com/W4ngatang/60c2bdb54d156a41194446737ce03e2e and revised some.
...
TASKS = [
    "CoLA", "SST", "MRPC", "QQP", "STS", "MNLI", "QNLI", "RTE", "WNLI",
    "diagnostic"
]
TASK2PATH = {
...
def format_mrpc(data_dir, path_to_data):
    ...
    dev_ids = []
    with io.open(os.path.join(mrpc_dir, "dev_ids.tsv"),
